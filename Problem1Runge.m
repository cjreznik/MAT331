%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%MAT 331 Project 3 Problem 1 Connie Reznik%%%%%%%%
%%%%%%%This code determines the interpolating polynomial of degree 4
%%%%%%%for the function f(x) = 1/(1+25x^2) on the interval (1,1)
%%%%%%%%with 4 nodes
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function val = Problem1Runge(n)

%set the lin space between -1 and 1 and create the 4 nodes
