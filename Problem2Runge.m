%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%MAT 331 Project 3 Problem 2 Connie Reznik%%%%%%%%
%%%%%%%This code determines the interpolating polynomial of degree 8
%%%%%%%for the function f(x) = 1/(1+25x^2) on the interval (1,1) but
%%%%%%% with 9 nodes instead of 4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

function val = Problem2Runge(n)
format short

%set the lin space between -1 and 1 and create the 9 nodes
x_n = linspace(-1,1,n+1);
